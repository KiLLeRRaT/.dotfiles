...
# Get current values
brightness_current=$(cat /sys/class/leds/spi::kbd_backlight/brightness)
brightness_max=$(cat /sys/class/leds/spi::kbd_backlight/max_brightness)
...
msgTag="my-keyboard-brightness"


dunstify \
	-a "set-keyboard-brightness" \
	-u low \
	-h string:x-dunst-stack-tag:$msgTag \
	-h int:value:"$brightness_percent" "Keyboard brightness: ${brightness_percent}%"

brightnessctl --device=spi::kbd_backlight set $brightness_new
